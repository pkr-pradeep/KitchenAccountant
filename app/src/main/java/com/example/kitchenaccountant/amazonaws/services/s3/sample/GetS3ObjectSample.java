...
public class GetS3ObjectSample {
    ...
    public static String getS3Object(String bucketName, String regionName, String awsAccessKey, String awsSecretKey) {
        ...
        try {
            return getJsonFromCloudFlare(headers);
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
    }

    public static String getJsonFromCloudFlare(Map<String, String> headers) throws IOException {
        OkHttpClient client = new OkHttpClient().newBuilder()
                .build();
        MediaType mediaType = MediaType.parse("text/plain");
        RequestBody body = RequestBody.create(mediaType, "");
        Request request = new Request.Builder()
                .url("https://5d01feafecb2aabc05a201911480947e.r2.cloudflarestorage.com/iskcon-kitchen-management/May_2024.json")
                .method("GET", null)
